...
CANONICAL_RULES: list[RuleObject] = [
    ...
    RuleObject(
        ...
        plain_label="Base price (pre-2026)",
    ...
    RuleObject(
        ...
        clause_id="4.4",
        source_circular_id=CIRCULAR_ID,
        plain_label="Base price — Phase 2 (T-1 NAV)",
    ...
    RuleObject(
        ...
        clause_id="5.1.1",
        source_circular_id=CIRCULAR_ID,
        plain_label="Price band — Equity & Debt ETFs",
    ...
    RuleObject(
        ...
        clause_id="5.2.1",
        source_circular_id=CIRCULAR_ID,
        plain_label="Price band — Overnight & Liquid ETFs",
    ...
    RuleObject(
        ...
        clause_id="5.3.1",
        source_circular_id=CIRCULAR_ID,
        plain_label="Price band — Gold & Silver ETFs",
    ...
    RuleObject(
        ...
        clause_id="6.1",
        source_circular_id=CIRCULAR_ID,
        plain_label="Close-out procedure",
    ...
    RuleObject(
        ...
        clause_id="7.1",
        source_circular_id=CIRCULAR_ID,
        plain_label="Pre-open call auction",
