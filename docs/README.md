...
| [SUBMISSION_NOTES.md](./SUBMISSION_NOTES.md) | Hackathon deck / form alignment checklist |
| [assets/screenshots/](./assets/screenshots/) | UI screenshots for README and deck |

## Screenshots (for deck / README)

| File | Use in deck |
|---|---|
| `01-matrix-simple-phase1.png` | Slide: compliance matrix — plain-English view |
| `02-matrix-technical-phase1.png` | Slide: deterministic fields / technical proof |
| `03-delta-before-apply.png` | Slide: regulatory delta detected |
...
All structured rules and UI citations are traced to these files.
